    ...
    <div className="index">
      ...
      <section className="mt-3">
        ...
        <table className="table-fixed w-full border-separate border-spacing-1">
          ...
          <tr><td>Price</td><td>{ formatNumber(stats.tdrop.price, 4) } ({ (stats.tdrop.price_change_percent_24h >= 0 ? '+' : '-') + formatNumber(Math.abs(stats.tdrop.price_change_percent_24h), 2) + '%' })</td></tr>
